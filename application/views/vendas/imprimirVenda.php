...
<head>
    <title><?= $configuration['app_name']?> - <?php echo $result->idVendas ?>_<?php echo $result->nomeCliente ?></title>
    <meta charset="UTF-8" />
                ...
                <div class="invoice-content">
                    ...
                    <div style="margin-top: 0; padding-top: 0">
                        <?php if ($produtos != null) { ?>
                          <table width="100%" align="center" class="table table-bordered table-condensed" id="tblProdutos">
                            <thead>
                              <tr>
                        ...
                        <hr align="center" />
                        <h4 align="center" style="text-align: right">Valor Total: R$
